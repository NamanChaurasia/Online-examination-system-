...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">namanchaurasia1530@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/n.jpg" width=100 height=100 alt="Naman Chaurasia" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Naman Chaurasia</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8896089011</h4>
		<h4 style="font-family:'typo' ">namanchaurasia1573@gmail.com</h4>
		<h4 style="font-family:'typo' ">MMMUT</h4></div></div>
		</p>
      </div>
